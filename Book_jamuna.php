...
<header id="navigation"> 
 ...
 <div class="row img-rounded" style="margin-top:2%; margin-left:1%; margin-right:.5%; background:hsla(0,4%,71%,1.00)">
 ...
 Thank you for using MILITRAVEL.</h3>
  ...
  <form action="jamuna_book.php" method="post">
    <div class="checkbox" style="margin-left:2%; margin-top:2%">
      <label style=" font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:20px; margin-top:2%"><input type="checkbox" name="avr">GANGSHALIK: Jamuna Officer's Mess</label>
    </div>
