...
<header id="navigation"> 
    ...
    <div class="row" style="height:auto; width:100%; margin-top:6%; margin-left:0px; margin-bottom: 5%" id="me1"> 
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 jumbotron" style="height: auto; color:  #0B0B2D; ">
           
 <h2 style="color:hsla(233,90%,24%,1.00); font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif"><center>REGISTERED USERS INFORMATION:</center></h2>
 <a class="btn btn-block btn-success" href="admin1.php" style="margin-bottom:10px; font-size:20px "><strong>USERS</strong></a>
 <h2 style="color:hsla(233,90%,24%,1.00); font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif"><center>RESOTRS RESEVATION REQUESTS:</center></h2>
  <a class="btn btn-block btn-primary" href="BCR_VIEW.php" style="margin-bottom:10px; font-size:20px "><strong>Banglow Cottage: RANGAMATI</strong></a>
   <a class="btn btn-block btn-primary" href="GRR_VIEW.php" style="margin-bottom:10px; font-size:20px "><strong>Gangshalik Villa: RANGAMATI</strong></a>
    <a class="btn btn-block btn-primary" href="ARR_VIEW.php" style="margin-bottom:10px; font-size:20px "><strong>Aronnok Villa: RANGAMATI</strong></a>
     <a class="btn btn-block btn-primary" href="MJ_VIEW.php" style="margin-bottom:10px; font-size:20px "><strong>GANGSHALIK: Jamuna Officer's Mess</strong></a>
      <a class="btn btn-block btn-primary" href="akashlina_view.php" style="margin-bottom:10px; font-size:20px "><strong>AKASHLINA: NILGIRI, BANDARBAN</strong></a>
       <a class="btn btn-block btn-primary" href="marma_1_view.php" style="margin-bottom:10px; font-size:20px "><strong>MARMA REESA-1: NILGIRI, BANDARBAN</strong></a>
           <a class="btn btn-block btn-primary" href="marma_2_view.php" style="margin-bottom:10px; font-size:20px "><strong>MARMA REESA-2: NILGIRI, BANDARBAN</strong></a>
  <a class="btn btn-block btn-primary" href="nilangana_1_view.php" style="margin-bottom:10px; font-size:20px "><strong>NILANGANA-1: NILGIRI, BANDARBAN</strong></a>
   <a class="btn btn-block btn-primary" href="nilangana_2_view.php" style="margin-bottom:10px; font-size:20px "><strong>NILANGANA-2: NILGIRI, BANDARBAN</strong></a>
   <a class="btn btn-block btn-primary" href="meghdut_view.php" style="margin-bottom:10px; font-size:20px "><strong>MEGHDUT: NILGIRI, BANDARBAN</strong></a>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 kio" style="height:auto; margin-top:0%; background:hsla(0,10%,79%,1.00)" id="kof">
  
       <div class="jumbotron">
       <img class="img-responsive" src="wingdevslogo1.png" height="auto" width="100%">
      <a class="btn btn-block btn-success" href="bus_view.php" style="margin-bottom:10px; font-size:20px; margin-top:8% "><strong>BUS BOOKING REQUEST</strong></a>
