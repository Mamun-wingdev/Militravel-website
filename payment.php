...
<header id="navigation"> 
    ...
    <div class="row" style="height:auto; width:100%; margin-top:7%; margin-left:0px; margin-bottom: 5%" id="me1"> 
 ...
 <div class="jumbotron">      
            <h4>All payment option has its own terms and conditions. All conditions are fullfiled here. </h4>
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 kio" style="height:auto; margin-top:2%; padding-bottom:2% " id="kof">
  
  <div class="jumbotron">
  
  <h2 style="color:hsla(244,82%,27%,1.00); font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif; text-align:center">To full fill your order you have to pay your bill</h2>
  
  <div class="container" style="padding-bottom:4%">
  <h3>Bill Pay  options are:</h3>
  <div class="list-group">
    <a href="products.php" class="list-group-item active">Paypal</a>
    <a href="#" class="list-group-item disabled">Bikask</a>
    <a href="#" class="list-group-item disabled">Debit Card</a>
    <a href="#" class="list-group-item disabled">Mobile Banking</a>
  </div>
</div>
