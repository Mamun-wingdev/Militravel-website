...
?>
<?php
$query= "select * from r_ban_nilangana_1";             
...
<h1 style="text-decoration:underline; font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif; color:hsla(241,90%,20%,1.00)"><center>REQUEST FOR NILANJANA 01 BANDARBAN</center></h1>
