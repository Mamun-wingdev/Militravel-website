...
?>
<?php
$query= "select * from r_ban_meghdut";             
						 ...
						 <li class="dropdown">
                              <a class="dropdown-toggle" data-toggle="dropdown" href="#">Popular locations
                                   ...
                                   <ul class="dropdown-menu">
                                         ...
                                         <li><a href="jamunamain.php">JOMUNA</a></li>
                                         <li><a href="rangamatimain.php">RANGAMATI</a></li> 
...
<h1 style="text-decoration:underline; font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif; color:hsla(241,90%,20%,1.00)"><center>REQUEST FOR MEGHDUT BANDARBAN</center></h1>
