...
<header id="navigation"> 
 ...
 <div class="row img-rounded" style="margin-top:12%; margin-left:1%; margin-right:.5%; background:hsla(0,4%,71%,1.00); padding-bottom:5%">
 
 <h3 style="color:hsla(242,87%,24%,1.00); font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;">All Booking process is connected linked with the main database of every individual resorts.
 All terms and condition of those resorts are reserved.
 Thank you for using MILITRAVEL.</h3>
  ...
  <form action="bandarban_book.php" method="post">
    <div class="checkbox" style="margin-left:2%; margin-top:2%">
      <label style=" font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:20px; margin-top:2%"><input type="checkbox" name="avr">Akashlina NIlgiri, Bandarban</label>
    </div>
    <div class="checkbox" style="margin-left:2%; margin-top:2%">
      <label style=" font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:20px"><input type="checkbox" name="br">Marmaressa_1 Nilgiri, Bandarban</label>
    </div>
    <div class="checkbox disabled" style="margin-left:2%; margin-top:2%">
      <label style=" font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:20px"><input type="checkbox" name="gvr">Marmaressa_2 Nilgiri, Bandarban</label>
    </div>
    <div class="checkbox disabled" style="margin-left:2%; margin-top:2%">
      <label style=" font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:20px"><input type="checkbox" name="nnb">Nilangana_1 Nilgiri, Bandarban</label>
    </div>
    <div class="checkbox disabled" style="margin-left:2%; margin-top:2%">
      <label style=" font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:20px"><input type="checkbox" name="nnb2">Nilangana_2 Nilgiri, Bandarban</label>
    </div>
    <div class="checkbox disabled" style="margin-left:2%; margin-top:2%">
      <label style=" font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:20px"><input type="checkbox" name="mnb">Meghdut Nilgiri, Bandarban</label>
    </div>
 ...
 <div class="form-group"  style="width:40%">
   ...
   <div style="width:40%; padding-bottom:1%;">
