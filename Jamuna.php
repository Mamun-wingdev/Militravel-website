  ...
  <div class="jumbotron">
   ...
   <button class=" btn btn-block btn-success">CLICK HERE</button>
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 kio" style="height:auto; margin-top:0%; background:hsla(0,10%,79%,1.00)" id="kof">
							...
							<div class="content" >
                            <h1   style="color: hsla(224,87%,30%,1.00); font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif"> <b>GANGSHALIK: Jamuna Officer's Mess</b></h1> 
    <hr color="#F00429" size="2em">
								
                                <h5 style="color: #16A88F">Rating: 8.2 </h5>
								<p id="special"><mark><b><ins>Location</ins></b></mark>: BANGABANDHU BRIDGE (East) Area.</p>
                                
<p id="special"><mark><b><ins>Services</ins></b></mark>: Detail messing with good standard of food & swimming pool facilities for the military guests</p>
<h4   id="special"><ul>
  <li>AC Room 500 per night									
</li>
  <li>Non AC Room 250 per night									
</li>
 
</ul>								
 </h4>
 
       <a class="btn btn-block btn-primary" href="loginjamuna.php" style="margin-bottom:10px; font-size:20px "><strong>BOOK NOW</strong></a>
<hr color="#F00429" size="2em">
<div class=" img-responsive img-rounded"><img src="images/j1.jpg" alt="" style="width:100%;height: auto;"/></div>

							</div>
		
        
        <div class="jumbotron" style="margin-top:2%; padding-bottom:4%">
        <h3 style="font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; text-align:center; color:hsla(240,87%,28%,1.00); padding-bottom:6%">No other resort is avaiable in Jamuna.</h3>
