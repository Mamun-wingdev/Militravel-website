...
<h1 style="text-decoration:underline; font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif; color:hsla(241,90%,20%,1.00)"><center>REQUEST FOR BUS BOOKING</center></h1>
...
?>
 ...
 <center> Serial no: <?php echo $a; ?><br><br></center>
  ...
  ID:  <?php	 echo $subject["id"];?> <br><br>
   Starting point:  <?php	 echo $subject["start"];?> <br><br>
   Destination:  <?php	 echo $subject["end"];?> <br><br>
  EMAIL ID:      <?php	 echo $subject["email"];?> <br><br> 
  ADDRESS:      <?php echo $subject["address"];?><br> <br>  
  Seat NO:     <?php	 echo $subject["seat"];?><br>  <br> 
